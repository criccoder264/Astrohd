// tg.js - Contains player setup, domain lock, and dynamic loading of ccapi.js
...
document.head.appendChild(script); // Append the script to the head to load ccapi.js
